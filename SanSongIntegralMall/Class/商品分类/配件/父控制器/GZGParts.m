...
@interface GZGParts ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
- (void)createBanner
{
    ...
    __block GZGParts *blockSelf = self;
