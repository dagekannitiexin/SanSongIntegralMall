...
@interface GZGGroceries ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
- (void)initNetWork
{
    ...
    [requestInfo setValue:@"00000000-0000-0000-0000-000000000006" forKey:@"typeId"];
    __weak GZGGroceries *weakSelf = self;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _arrayTitle = [NSMutableArray arrayWithObjects:@"杂货",@"唇膏",@"面膜",@"眼影",@"乳液面霜",@"面部精华",@"男士护肤", nil];
...
- (void)createBanner
{
    ...
    __block GZGGroceries *blockSelf = self;
