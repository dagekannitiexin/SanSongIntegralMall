...
@interface GZGClothes ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
- (void)createBanner
{
    ...
    //创建轮转图
    __weak GZGClothes *weakSelf = self;
    ...
    __block GZGClothes *blockSelf = self;
