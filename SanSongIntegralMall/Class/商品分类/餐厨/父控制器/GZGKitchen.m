...
@interface GZGKitchen ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
- (void)createBanner
{
    ...
    //创建轮转图
    __weak GZGKitchen *weakSelf = self;
    ...
    __block GZGKitchen *blockSelf = self;
