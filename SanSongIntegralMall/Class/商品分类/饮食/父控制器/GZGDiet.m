...
@interface GZGDiet ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
- (void)createBanner
{
    ...
    __block GZGDiet *blockSelf = self;
