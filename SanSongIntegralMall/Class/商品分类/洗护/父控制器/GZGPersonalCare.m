...
@interface GZGPersonalCare ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
@implementation GZGPersonalCare
...
- (void)createBanner
{
    ...
    //创建轮转图
    __weak GZGPersonalCare *weakSelf = self;
    ...
    __block GZGPersonalCare *blockSelf = self;
