...
@interface GZGNewProduc ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
- (void)createBanner
{
    ...
    //创建轮转图
    __weak GZGNewProduc *weakSelf = self;
    ...
    __block GZGNewProduc *blockSelf = self;
