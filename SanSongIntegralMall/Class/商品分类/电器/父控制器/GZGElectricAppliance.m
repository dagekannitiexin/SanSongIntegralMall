...
@interface GZGElectricAppliance ()<SDCycleScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>{
    UIView *_headView;
...
@implementation GZGElectricAppliance
...
- (void)initNetWork
{
    ...
    [requestInfo setValue:@"00000000-0000-0000-0000-000000000004" forKey:@"typeId"];
    __weak GZGElectricAppliance *weakSelf = self;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _arrayTitle = [NSMutableArray arrayWithObjects:@"电器",@"唇膏",@"面膜",@"眼影",@"乳液面霜",@"面部精华",@"男士护肤", nil];
...
- (void)createBanner
{
    ...
    __block GZGElectricAppliance *blockSelf = self;
